...
public class AdvancedDetectionOpMode extends LinearOpMode {
    ...
    public void runOpMode()
    {
        ...
        //OpenCV Pipeline
        AdvancedDetection myPipeline;
        camera.setPipeline(myPipeline = new AdvancedDetection(borderLeftX,borderRightX,borderTopY,borderBottomY));
    ...
    public void testing(AdvancedDetection myPipeline){

...
public class AdvancedDetection extends OpenCvPipeline {
    ...
    public AdvancedDetection(double borderLeftX, double borderRightX, double borderTopY, double borderBottomY) {
